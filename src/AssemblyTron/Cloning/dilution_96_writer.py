    ...
    if x in section['parts'].values:
        ...
        for i, row in df.iterrows():
            if df.loc[i].at['water to add'] > 20:
                f.write(
                    "    left_pipette.pick_up_tip() \r\n"
                    "    left_pipette.aspirate("+str(df.loc[i].at['amount of template to add'])+", "+str(globals()[df.loc[i].at['rack']])+"['"+str(df.loc[i].at['template_origin'])+"'], rate=2.0) \r\n"
            ...
            if 10 < df.loc[i].at['water to add'] < 20:
                f.write(
                    "    left_pipette.pick_up_tip() \r\n"
                    "    left_pipette.aspirate("+str(2*(df.loc[i].at['amount of template to add']))+", "+str(globals()[df.loc[i].at['rack']])+"['"+str(df.loc[i].at['template_origin'])+"'], rate=2.0) \r\n"
            ...
            if 3.333 < df.loc[i].at['water to add'] < 10:
                f.write(
                    "    left_pipette.pick_up_tip() \r\n"
                    "    left_pipette.aspirate("+str(3*(df.loc[i].at['amount of template to add']))+", "+str(globals()[df.loc[i].at['rack']])+"['"+str(df.loc[i].at['template_origin'])+"'], rate=2.0) \r\n"
            ...
            if 1 < df.loc[i].at['water to add'] < 3.333:
                f.write(
                    "    left_pipette.pick_up_tip() \r\n"
                    "    left_pipette.aspirate("+str(4*(df.loc[i].at['amount of template to add']))+", "+str(globals()[df.loc[i].at['rack']])+"['"+str(df.loc[i].at['template_origin'])+"'], rate=2.0) \r\n"
            ...
            if df.loc[i].at['water to add'] < 1:
                f.write(
                    "    left_pipette.pick_up_tip() \r\n"
                    "    left_pipette.aspirate("+str(6*(df.loc[i].at['amount of template to add']))+", "+str(globals()[df.loc[i].at['rack']])+"['"+str(df.loc[i].at['template_origin'])+"'], rate=2.0) \r\n"
        ...
        for i, row in oligos.iterrows():
            f.write(
                "    left_pipette.pick_up_tip() \r\n"
                "    left_pipette.aspirate("+str(oligos.loc[i].at['volume of stock primer to add'])+", "+str(globals()[oligos.loc[i].at['rack']])+"['"+str(oligos.loc[i].at['24well'])+"'], rate=1.0) \r\n"
